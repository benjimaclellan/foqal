...
init_file = {}
with open("../../foqal/__version__.py") as f:
...
latex_documents = [
    (master_doc, "Foqal.tex", "Foqal Documentation", "PIQuIL", "manual")
]
...
man_pages = [(master_doc, "foqal", "Foqal Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "Foqal",
        "Quantum foils, differentiable models.",
        "Miscellaneous",
    )
]
